...
This plugin is customized for this project's tech stack:
- React 19 + TypeScript
...
Based on [anthropics/claude-code/plugins/frontend-design](https://github.com/anthropics/claude-code/tree/main/plugins/frontend-design)
