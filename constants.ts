...
export const MOCK_POLITICIANS: Politician[] = [
  ...
  },
  {
    ...
    location: 'Pernambuco',
    photoUrl: 'https://www.alepe.pe.gov.br/wp-content/uploads/2023/02/carla-dizeu.jpg',
  ...
  },
  {
    ...
    location: 'Recife',
    photoUrl: 'https://ui-avatars.com/api/?name=Ant%C3%B4nio+Silva&background=dc2626&color=fff&size=200',
